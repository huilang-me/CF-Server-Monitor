...
const translations = reactive({
  en: {
    ...
    versionConflict: 'The configuration was changed elsewhere. Latest data has been loaded; review it and try again.',
  ...
  zh: {
    ...
    versionConflict: '配置已被其他操作修改，已重新加载最新数据，请确认后重试。',

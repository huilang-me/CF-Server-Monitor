...
const translations = reactive({
  en: {
    ...
    historyIdOptimization: 'History Query Optimization',
    enableHistoryIdOptimization: 'Use ID index for history queries',
    historyIdOptimizedWarning: 'After enabling, secondary indexes may be cleaned. You cannot roll back code and this setting cannot be disabled.',
    historyIdOptimizedConfirm: 'Enable history ID optimization? After enabling, you cannot roll back code and this setting cannot be disabled.',
    historyIdConditionNoIndex: 'No server_id + timestamp index',
    historyIdConditionMinId: 'Minimum id above threshold',
    historyIdConditionSetting: 'Manual setting enabled',
    historyIdConditionOn: 'ON',
    historyIdConditionOff: 'OFF',
    historyIdCurrentMode: 'Current history query mode',
    historyIdModeId: 'ID index',
    historyIdModeCompat: 'server_id + timestamp',
    historyIdMinId: 'Minimum id',
    historyIdThreshold: 'Threshold',
  ...
  zh: {
    ...
    historyIdOptimization: '历史查询优化',
    enableHistoryIdOptimization: '使用 ID 索引查询历史数据',
    historyIdOptimizedWarning: '开启后可能清理二级索引；不允许回滚代码，且此设置不能再关闭。',
    historyIdOptimizedConfirm: '确认开启历史 ID 查询优化？开启后不允许回滚代码，且此设置不能再关闭。',
    historyIdConditionNoIndex: '没有 server_id + timestamp 索引',
    historyIdConditionMinId: '最小 id 大于阈值',
    historyIdConditionSetting: '手动设置已开启',
    historyIdConditionOn: '开启',
    historyIdConditionOff: '关闭',
    historyIdCurrentMode: '当前历史查询模式',
    historyIdModeId: 'ID 索引',
    historyIdModeCompat: 'server_id + timestamp',
    historyIdMinId: '最小 id',
    historyIdThreshold: '阈值',
    historyIdLocked: '已锁定',

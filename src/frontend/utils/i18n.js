...
const translations = reactive({
  en: {
    ...
    optimizeIndex: 'Optimize Index',
    optimizeIndexDesc: 'Switch history data to ID primary-key queries and remove compatibility index writes.',
    optimizeIndexWarning: 'This action will clear all historical data. Continue?',
    optimizeIndexDetails: 'Index optimization can reduce D1 writes for history data by about half. If you do not run it now, the system will automatically optimize after up to two weekly rotations. Manual optimization clears all historical data.',
    confirmOptimizeIndex: 'Confirm Optimize',
    ...
    historyIndexOptimizedSuccess: 'History index optimized successfully',
    historyIndexOptimizedFailed: 'History index optimization failed',
  ...
  zh: {
    ...
    optimizeIndex: '优化索引',
    optimizeIndexDesc: '切换历史数据为 id 主键查询，并移除兼容索引写入。',
    optimizeIndexWarning: '此操作将清空所有历史数据，确定吗？',
    optimizeIndexDetails: '优化索引将减少历史数据约一半的 D1 写入。如果不执行，最晚两次周日表轮换后将自动优化。手动优化将清空所有历史数据。',
    confirmOptimizeIndex: '确认优化',
    notifications: '通知',
    offlineAlert: '离线告警',
    expireReminder: '到期提醒',
    disabled: '禁用',
    ...
    historyIndexOptimizedSuccess: '历史索引优化成功',
    historyIndexOptimizedFailed: '历史索引优化失败',

...
const translations = reactive({
  en: {
    ...
    historyIdOptimization: 'Query Index Optimization',
    enableHistoryIdOptimization: 'Force ID primary-key query',
    historyIdOptimizedWarning: 'Note: if any condition below is met, history queries use the ID primary key; otherwise they use the server_id + timestamp composite index. Manual enablement cannot be disabled and code must not be rolled back.',
    historyIdOptimizedConfirm: 'Enable query index optimization? After enabling, you cannot roll back code and this setting cannot be disabled.',
    historyIdConditionNoIndex: 'No server_id + timestamp composite index',
    historyIdConditionMinId: 'Minimum id is above threshold',
    historyIdConditionSetting: 'Manual setting is enabled',
    historyIdConditionOn: 'Met',
    historyIdConditionOff: 'Not met',
    historyIdCurrentMode: 'Current query mode',
    historyIdModeId: 'ID primary-key index',
    historyIdModeCompat: 'server_id + timestamp composite index',
    historyIdMinId: 'Current minimum id',
    historyIdLocked: 'Locked',
    historyIdOptimizedCannotDisable: 'History ID optimization cannot be disabled after it has been enabled',
    ...
    telegramToken: 'Telegram Token / WeChat / Feishu / Bark',
    chatId: 'Chat ID',
  ...
  zh: {
    ...
    historyIdOptimization: '查询索引优化',
    enableHistoryIdOptimization: '强制使用 id 主键查询',
    historyIdOptimizedWarning: '注意事项：满足任意一项自动开启使用id主键查询，否则使用server_id + timestamp联合索引查询。手动开启后不能再关闭，且不允许回滚代码。',
    historyIdOptimizedConfirm: '确认开启查询索引优化？开启后不允许回滚代码，且此设置不能再关闭。',
    historyIdConditionNoIndex: '没有 server_id + timestamp 联合索引',
    historyIdConditionMinId: '最小 id 大于阈值',
    historyIdConditionSetting: '手动设置已开启',
    historyIdConditionOn: '已满足',
    historyIdConditionOff: '不满足',
    historyIdCurrentMode: '当前查询模式',
    historyIdModeId: 'id主键索引',
    historyIdModeCompat: 'server_id + timestamp联合索引',
    historyIdMinId: '当前最小 id',
    historyIdLocked: '已锁定',
    historyIdOptimizedCannotDisable: '历史 ID 查询优化开启后不能关闭',
    notifications: '通知',
    offlineAlert: '离线告警',
    expireReminder: '到期提醒',
    disabled: '禁用',
    ...
    telegramToken: 'Telegram Token / 企业微信 / 飞书 / Bark',
    chatId: '聊天 ID',
    saveConfig: '保存配置',
    saving: '保存中...',
    hostnameLabel: '主机名',
